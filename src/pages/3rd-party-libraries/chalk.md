...
<header align="center">
	<br>
	<br>
	<img width="320" src="https://raw.githubusercontent.com/chalk/chalk/main/media/logo.png" alt="Chalk">
	<br>
	<br>
	<br>
</header>
...
![](https://github.com/chalk/chalk/blob/main/media/screenshot.png)
